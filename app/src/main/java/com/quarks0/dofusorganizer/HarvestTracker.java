...
public class HarvestTracker extends AppCompatActivity {
    ...
    private void initiateList() { //Populates the EH list
        ...
        step2.add("Sick Tofu");
        step2.add("Mush Mush");
        step2.add("Evil Dandelion");
        step2.add("Agressive Arachnee");
        step2.add("One-armed Bandit");
        step2.add("Demonic Rose");
        step2.add("Blue Jelly");
        step2.add("Kwoan");
        step2.add("Green Larva");
        step2.add("Gobball");
        step2.add("Kolerat");
        step2.add("Mint Jelly");
        step2.add("Orange Larva");
        step2.add("Dark Baker");
        step2.add("Black Tiwabbit");
        step2.add("Tiwabbit");
        step2.add("Tiwabbit Wosungwee");
        step2.add("Wild Sunflower");
        step2.add("Rogue Clan Bandit");
        step2.add("Goblin");
        ...
        step3.add("Glukoko");
        step3.add("Boar");
        step3.add("Green Spimush");
        step3.add("Pumpkwin");
        step3.add("Vampyre");
        step3.add("Coco Biblop");
        step3.add("Morello Cherry Biblop");
        step3.add("Indigo Biblop");
        step3.add("Pippin Biblop");
        step3.add("Karne Rider");
        step3.add("Sick Grossewer Milirat");
        step3.add("Mushd");
        step3.add("Prespic");
        step3.add("Piglet");
        step3.add("Yellow Turtle");
        step3.add("Wabbit");
        step3.add("Gobbal War Chief");
        step3.add("Lousy Pig Shepherd");
